...
/*************  ✨ Codeium Command ⭐  *************/
    /**
     * Endpoint to retrieve user details from a valid JWT token.
     * 
     * @param token The JWT token obtained after a successful login.
     * @return A JSON response containing the user ID, username, and email if the token is valid,
     *         otherwise a JSON response with a message indicating the error.
     */
/******  478d88b0-ab84-4012-83db-535ba4aebc2f  *******/
    @GetMapping("/user")
