...
const Logo = ({ size = "md" }) => {
  ...
  return (
    ...
    >
      ...
      <path 
        d="M0 50 Q30 30, 60 50 T120 50 T180 50 T240 50 T300 50"
...
okk so this is my logo.jsx file. 
i want the rope to cover the ehole width of the screen and look like this. the astronaut must be in the middle of the rope