...
const Logo = ({ size = "md" }) => {
  ...
  return (
    ...
    >
      ...
      <polygon 
        points={`${astronautX + 15},${astronautY + 14} ${astronautX + 13},${astronautY + 24} ${astronautX + 23},${astronautY + 24} ${astronautX + 16},${astronautY + 30} ${astronautX + 18},${astronautY + 40} ${astronautX + 10},${astronautY + 34} ${astronautX + 2},${astronautY + 40} ${astronautX + 4},${astronautY + 30} ${astronautX - 4},${astronautY + 24} ${astronautX + 7},${astronautY + 24}`} 
        fill="white" 
        opacity="0.9"
      />
