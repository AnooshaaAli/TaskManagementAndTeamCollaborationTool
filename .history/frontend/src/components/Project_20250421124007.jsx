...
import { Folder, Loader, UserPlus, UserMinus, Users, MessageSquare, X } from 'lucide-react';
    ...
    return (
        <div className="project-wrapper">
            ...
            <div className="project-content-wrapper">
                <div className={`project-board ${showCommentsSidebar ? 'with-sidebar' : ''}`}>
                ...
                {showFilesSidebar && (
                    <div className="files-sidebar">
                        ...
                        <div className="file-list">
                            {commentCount > 0 ? (
                                Object.values(project.files).map(comment => (
                                    <Comment key={file.fileID} comment={comment} />
                                ))
                            ) : (
                                <div className="no-comments">
                                    No comments yet. Be the first to add one!
