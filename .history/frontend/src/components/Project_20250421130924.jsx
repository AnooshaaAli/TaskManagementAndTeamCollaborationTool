...
import { Folder, Loader, UserPlus, UserMinus, Users, MessageSquare, X, FileText, ChevronLeft, ChevronRight } from 'lucide-react';
...
function Project({ id }) {
    ...
    const toggleCommentsSidebar = () => {
        setShowCommentsSidebar(prev => {
            const newValue = !prev;
            if (newValue) setShowFilesSidebar(false); 
            return newValue;
        });
    };
    ...
    const toggleFilesSidebar = () => {
        setShowFilesSidebar(prev => {
            const newValue = !prev;
            if (newValue) setShowCommentsSidebar(false); // close comments if opening files
            return newValue;
        });
    };
        ...
        <div className="project-wrapper">
            <div className="project-header">
                ...
                <Button 
                    ...
                    aria-label={showCommentsSidebar ? "Hide comments" : "Show comments"}
                >
                    <MessageSquare size={16} />
                    <span>Comments</span>
                    {showFilesSidebar ? <ChevronRight size={14} /> : <ChevronLeft size={14} />}
                    {commentCount > 0 && (
            ...
            <div className="project-content-wrapper">
                <div className={`project-board ${showCommentsSidebar ? 'with-sidebar' : ''} ${showFilesSidebar ? 'sidebar-open' : ''}`}>
