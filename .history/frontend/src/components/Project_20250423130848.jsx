                ...
                <div className="tabs-container">
                    ...
                    {isTeamLead && (
                        <>
                            ...
                            {/* Delete Project Button moved to tabs */}
                            <button 
                                className="tab delete-project-tab"
                                onClick={() => {
                                    // This will be handled by the DeleteProject component
                                    // We just need to make the button visible here
                                }}
                            >
                                <div className="delete-project-svg">
                                    <Trash2 size={16} />
                                </div>
