...
function ViewTeam({ projectId, onTeamSizeChange(data.length);}) {
    const [teamMembers, setTeamMembers] = useState([]);
    const [loading, setLoading] = useState(false);
    const [profilePics, setProfilePics] = useState({});  // Store profile pics here
    ...
    const fetchTeamMembers = async () => {
        ...
        try {
            ...
            // Fetch profile pics for each team member
            data.forEach(member => {
