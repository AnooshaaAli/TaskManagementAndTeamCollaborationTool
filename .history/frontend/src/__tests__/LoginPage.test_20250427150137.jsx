...
describe("LoginPage Component", () => {
  test("renders LoginPage component", () => {
    render(<LoginPage />);
    // Check if the login page title and subtitle are rendered
  ...
  test("password field shows error when left empty", () => {
    ...
    fireEvent.blur(passwordInput); // Simulate losing focus
  ...
  test("form submission with valid credentials", async () => {
    ...
    // Wait for the success message and check if the user is redirected (using mock of window.location)
