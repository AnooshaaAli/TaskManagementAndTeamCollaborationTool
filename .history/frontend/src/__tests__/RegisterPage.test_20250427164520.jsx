...
describe("LoginPage Component", () => {
    ...
    test('renders all fields correctly', () => {
      ...
      test('redirects to login on successful registration', async () => {
        ...
        fireEvent.change(screen.getAllByLabelText(/password/i)[0], { target: { value: 'password123' } }); // For the password field
        fireEvent.change(screen.getAllByLabelText(/password/i)[0], { target: { value: 'password123' } }); // For the confirm password field
