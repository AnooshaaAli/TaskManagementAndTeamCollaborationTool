...
import TeamMemberForm, { addMemberToTeam } from "../components/AddMember"; // Import both TeamMemberForm and addMemberToTeam correctly

jest.mock("../components/AddMember", () => ({
    // Mock the addMemberToTeam function only
