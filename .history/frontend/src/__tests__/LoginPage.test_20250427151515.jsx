...
describe("LoginPage Component", () => {
  ...
  import LoginPage from './LoginPage'; // Make sure this imports your LoginPage component
  
  test("email field shows error for invalid email format", () => {
    render(<LoginPage />);
    
    // Get the email input by its label
    const emailInput = screen.getByLabelText(/Email/i);
    
    // Simulate a change event with an invalid email value
    fireEvent.change(emailInput, { target: { value: 'invalidemail' } });
    
    // Simulate a blur event (when the input loses focus)
