...
describe("LoginPage Component", () => {
    ...
    test('renders all fields correctly', () => {
      ...
      it('redirects to login on successful registration', async () => {
        // Mock the location.assign method to simulate redirection
        const assignMock = jest.fn();
        const originalLocation = window.location;
        delete window.location;
        window.location = { assign: assignMock };
    
        // Render the RegisterPage component wrapped in a Router for routing
        render(
          <Router>
            <RegisterPage />
          </Router>
        ...
        // Wait for the mock to be called with the expected redirect URL
        await waitFor(() => {
