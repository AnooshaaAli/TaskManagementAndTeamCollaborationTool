...
describe('DashboardPage', () => {
  ...
  test('shows notifications when bell clicked', async () => {
    ...
    // Select the bell div using its role or aria-label
    const bellButton = screen.getByRole('button', { name: /notification bell/i });
  
    // Simulate a click event on the bell button
