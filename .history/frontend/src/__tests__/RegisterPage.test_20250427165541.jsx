...
describe("LoginPage Component", () => {
    ...
    test('renders all fields correctly', () => {
      ...
      test('redirects to login on successful registration', async () => {
        ...
        // Mock the redirection by replacing window.location
        ...
        // Ensure any timers (like setTimeout) are run
        jest.runAllTimers();  // Advances all timers, including the setTimeout for redirection
