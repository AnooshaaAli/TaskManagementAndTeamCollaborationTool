...
describe('DashboardPage', () => {
  ...
  test('shows notifications when bell clicked', async () => {
    ...
    // Select the button by class name or another selector
    const bellButton = screen.getByClassName('notification-bell');  // You could also try getByTagName or other selectors here
