...
describe('ProjectsPage', () => {
  ...
  test('renders project page content', async () => {
    ...
    // Assert that there are at least 1 element with the text "Projects"
    expect(projectElements.length).toBeGreaterThan(0);
  
    // You can check specific matches by using projectElements[0], if necessary
    expect(projectElements[0]).toBeInTheDocument();
  
    // Ensure the ProjectContainer component is rendered
