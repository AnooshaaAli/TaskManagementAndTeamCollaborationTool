...
// Ensure the mock is called in the right place
expect(assignMock).toHaveBeenCalledTimes(1);  // Check if it's called once

await waitFor(() => {
  console.log('Checking if redirect happens');
  expect(assignMock).toHaveBeenCalledWith('/login'); // Ensure the right argument is passed
});
