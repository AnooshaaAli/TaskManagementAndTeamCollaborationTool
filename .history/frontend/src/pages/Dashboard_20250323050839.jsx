...
import ProjectContainer from '../compoents/ProjectContainer'; // Import your component
import "../styles/styles.css";
import "../styles/dashboard.css";
import "../proje/projects_container.css";
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        const mockUserData = {
          id: "1234", // Added user ID for ProjectContainer
          name: "Alex Johnson",
            ...
            {activeTab === 'projects' && (
              <Card className="projects-card">
                <div className="project-container-wrapper">
                  {/* Integrated ProjectContainer component */}
                  <ProjectContainer userID={userData.id} />
                </div>
              </Card>
            )}
